...
function SignUpRoute() {
  return (
    <section className="bg-white">
      <div className="w-full lg:grid lg:min-h-body lg:grid-cols-12">
        <section className="relative flex h-32 bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="mt-24 hidden lg:relative lg:block lg:p-12">
        ...
        <main className="flex items-center justify-center px-8 py-2 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative block lg:hidden">
              <h1 className="mb-4 mt-2 text-2xl font-bold sm:text-3xl md:text-4xl">
                Welcome to Codesplain!
              </h1>
            </div>
