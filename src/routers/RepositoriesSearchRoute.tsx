...
import { IRepository } from '../components/repositories/types'
...
function RepositoriesSearchRoute() {
  ...
  const renderedRepositories = repositories?.map((r: IRepository) => {
    return <RepositoriesListItem key={r.full_name} repository={r} />
  })
